...
class Lagrangequadratic extends React.Component
{
    ...
    LagrangequadraticCalcFunction(point1,point2,point3,x)
    {
    ...
    handleSubmit(event){
        ...
        this.LagrangequadraticCalcFunction(point1,point2,point3,x)
...
export default Lagrangequadratic